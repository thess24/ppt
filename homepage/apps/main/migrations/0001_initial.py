...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_product', (
            ...
            ('purchases', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('product_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('sale_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True)),
        ...
        db.create_table(u'main_productimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'main', ['ProductImage'])
        ...
        db.create_table(u'main_purchase', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Product'])),
            ('sale_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.create_table(u'main_usercard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('usertoken', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'main', ['UserCard'])
        ...
        db.create_table(u'main_userprofile', (
            ...
            ('stripe_publishable_key', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
    ...
    models = {
        ...
        u'main.product': {
            ...
            'product_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'purchases': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sale_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
        ...
        u'main.productimage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Product']"}),
        ...
        u'main.purchase': {
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Product']"}),
            'sale_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.usercard': {
            ...
            'usertoken': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
        u'main.userprofile': {
            ...
            'stripe_publishable_key': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'taggit.tag': {
